...
const checks = [
  ...
  ['选择学期使用圆角跟手抽屉', css.includes('.semester-current-mark') && css.includes('border-radius: 18px') && app.includes('clipPath = `inset(0 ${reveal}px 0 0 round 16px)`') && app.includes('if (offset > 0) offset = 0')],
